...
function CommentModel({ setShow, show, data }) {
  ...
  function handleCloseandsave() {
    axios.put(`${Urlaxios}/CommentRouts/updateComment/${data._id}`, {
      text: text
    }, {
      headers: {
  ...
  return (
    <>
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <input type="text" onChange={(e) => settext(e?.target?.value)} value={text} style={{ width: "100%", padding: "5px", borderRadius: "5px", border: "1px solid #4c6177" }} />
        </Modal.Body>
        <Modal.Footer>
