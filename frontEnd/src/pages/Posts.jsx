...
const Posts = () => {
  ...
  return (
    <div className="container my-5 ">
      ...
      >
        <span style={{padding : "0 7px" ,width:"max-content"  , borderRadius :" 10px 0 0 10px" }} className="page">Prev</span>
        {[1, 2, 3, 4, 5].map((page) => {
          return (
            <div>
        ...
        <span style={{padding : "0 7px" ,width:"max-content" , borderRadius :" 0 10px 10px 0"  }} className="page">Next</span>
      </div>
    </div>
  );
};
